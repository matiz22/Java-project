...
//        indeksGwiazd.indeks.add(new Gwiazda("JCJ2140", "Orzeł", Polkula.PN, 0.1, 2001, "50 stopni 50 minut 30.30 sekund", "12 h 30 min 23 ss", 14, 2, LiteryGreckie.Chi));
//        indeksGwiazd.indeks.add(new Gwiazda("JCJ2139", "Orzeł", Polkula.PD, 20, 5001, "50 stopni 50 minut 30.30 sekund", "12 h 30 min 23 ss", 14, 2, LiteryGreckie.Chi));
...
//        indeksGwiazd.indeks.add(new Gwiazda("JCJ2136", "Orzeło", Polkula.PD, 50, 24001, "50 stopni 50 minut 30.30 sekund", "12 h 30 min 23 ss", 14, 2, LiteryGreckie.Chi));
        int control;
        while (true) {
            menu();
            try {
